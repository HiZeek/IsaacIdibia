...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    // Check if any of the input fields is blank
    if (name === "" || email === "" || project === "") {
      // You can display an error message or handle it as needed
      alert("Please fill in all fields");
    } else {
      // All fields have values, so you can send the email
      emailjs.sendForm(
        "service_l4q1kya",
        "template_knvd50x",
        form.current,
        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <span className="contact-card-data">idibiaisaac3@gmail.com </span>
              <a
            ...
            <div className="contact-card">
              ...
              <span className="contact-card-data">+234-812-212-9831 </span>
              <a
                href="https://wa.me/message/QBO4WF6BSRU3M1"
                className="contact-button"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
